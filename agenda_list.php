...
if (empty($_SESSION['admin'])) {
    ...
    if (isset($_REQUEST['submit'])) {
        ...
        if ($_REQUEST['dari_tanggal'] == "" || $_REQUEST['sampai_tanggal'] == "") {
            header("Location: ./admin.php?page=lsa");
            die();
        } else {
            ...
            echo '
                            ...
                            <div class="z-depth-1">
                                <nav class="secondary-nav">
                                    <div class="nav-wrapper blue-grey darken-1">
                                        <div class="col 12">
                                            <ul class="left">
                                                <li class="waves-effect waves-light"><a href="?page=lsa" class="judul"><i class="material-icons">print</i> Cetak Agenda Kegiatan<a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </nav>
                    ...
                    <!-- Tampilan Print Agenda Surat Masuk -->

                    <div class="row agenda">
                        <div class="col s10">
                            <div class="disp hidd">
                                <img class="logodisp" src="./asset/img/jateng.png"/>
								<h6 class="up">Aplikasi Manajemen Surat</h6>
								<h5 class="up" id="nama">DISPERMADESDUKCAPIL</h5><br/>
								<h6 class="status"></h6><br/>
								<span id="alamat">Jl. Menteri Supeno No.17, Semarang</span>
                            </div>
                            <div class="separator"></div>
                            <h5 class="hid">AGENDA KEGIATAN</h5>';

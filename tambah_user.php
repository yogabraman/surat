    ...
    if (isset($_REQUEST['submit'])) {
        ...
        <div class="row jarak-form">
            ...
            <form class="col s12" method="post" action="?page=sett&sub=usr&act=add">
                ...
                <!-- Row in form START -->
                <div class="row">
                    <div class="input-field col s6 tooltipped" data-position="top" data-tooltip="Username minimal 3 karakter [ huruf, angka atau underscore(_) ]">
                    ...
                    <div class="input-field col s6">
                        ...
                        <select id="bidang" type="text" name="bidang" required>
                            <option></option>
                            <?php
                        ...
                        if (isset($_SESSION['bidang'])) {
                            ...
                            echo '<div id="alert-message" class="callout bottom z-depth-1 red lighten-4 red-text">' . $bidang . '</div>';

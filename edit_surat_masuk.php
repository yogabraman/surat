<?php
    ...
    if(empty($_SESSION['admin'])){
        ...
        $query = mysqli_query($config, "SELECT m.id_surat, m.no_agenda, m.no_surat, m.asal_surat, m.isi, m.tgl_surat, m.file, m.keterangan, m.id_user FROM tbl_surat_masuk m WHERE id_surat='$id_surat'");
